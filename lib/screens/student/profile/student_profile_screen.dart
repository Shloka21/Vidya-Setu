        ...
        child: Column(
          ...
          children: [
            ...
            _NotificationToggle(
              ...
              subtitle: 'Updates about your sessions',
              value: true,
              onChanged: (value) {},
            ),
            const SizedBox(height: 20),
        ...
        child: Column(
          ...
          children: [
            ...
            _HelpOption(
              ...
              subtitle: 'support@vidyasetu.com',
              onTap: () async {
                Navigator.pop(context);
                final uri = Uri.parse('mailto:support@vidyasetu.com');
            ...
            child: Column(
              ...
              children: [
                _FAQItem(
                  ...
                  answer:
                      'Go to the Explore tab, find a mentor, and tap "Book Session" to schedule.',
                ),
                _FAQItem(
                  question: 'How does XP work?',
                  answer:
                      'You earn XP by completing sessions, daily logins, and achievements.',
                ),
                _FAQItem(
                  question: 'Can I change my mentor?',
                  answer:
                      'Yes, you can book sessions with any available mentor at any time.',
                ),
                _FAQItem(
                  question: 'How do I cancel a session?',
                  answer:
                      'Go to My Sessions, select the session, and tap Cancel. Please cancel at least 2 hours before.',
                ),
              ],
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Container(
        ...
        child: Icon(icon, color: DesignSystem.primaryIndigo),
      ),
